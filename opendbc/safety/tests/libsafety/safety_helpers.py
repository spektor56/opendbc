...
def setup_safety_helpers(ffi):
  ...
  void set_brake_pressed_prev(bool);
  bool get_brake_pressed(void);
  void set_brake_pressed(bool);
  bool get_lkas_enabled_prev(void);
  void set_lkas_enabled_prev(bool);
  bool get_lkas_enabled(void);
  void set_lkas_enabled(bool);
...
class PandaSafety(Protocol):
  ...
  def set_brake_pressed(self, c: bool) -> None: ...
  def get_brake_pressed(self) -> bool: ...
  def set_brake_pressed_prev(self, c: bool) -> None: ...
  def get_brake_pressed_prev(self) -> bool: ...
  def set_lkas_enabled(self, c: bool) -> None: ...
  def get_lkas_enabled(self) -> bool: ...
  def set_lkas_enabled_prev(self, c: bool) -> None: ...
  def get_lkas_enabled_prev(self) -> bool: ...
  ...
  def set_vehicle_moving(self, c: bool) -> None: ...
